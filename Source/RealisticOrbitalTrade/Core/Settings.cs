    ...
    internal class Settings : ModSettings
    {
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(
                ...
                "activeTradePausesDepartureTimer",
                false
            );
            Scribe_Values.Look(
            ...
            Scribe_Values.Look(
                ref _showIlyvionLaboratoryWarning,
                "showIlyvionLaboratoryWarning",
                true
            );
        ...
        public static void DoSettingsWindowContents(Rect inRect)
        {
            ...
            if (Prefs.DevMode)
            {
                listingStandard.CheckboxLabeled(
                    "DEV: Print dev log messages (rather verbose)",
            ...
            listingStandard.TextFieldNumeric(
                ref _minimumTradeThreshold,
                ref _minimumTradeThresholdBuffer
            );

            listingStandard.Label(
                "RealisticOrbitalTrade.MinimumTradeVariationLabel".Translate(
                    _minimumTradeDeviation
                ),
                -1f,
                "RealisticOrbitalTrade.MinimumTradeVariationTooltip".Translate(
                    _minimumTradeDeviation
                )
            );
            ...
            if (_activeTradePausesDepartureTimer)
            {
                listingStandard.Label(
                    "<color=#ffff00>"
                        + "RealisticOrbitalTrade.NoEffectWhenActiveTradePausesDepartureIsEnabled".Translate()
                        + "</color>"
                );
            }
            ...
            var minHoursUntilDepartureBeforeGraceTime =
                _minTicksUntilDepartureBeforeGraceTime / 2500f;
            listingStandard.Label(
                string.Format(
                    CultureInfo.CurrentCulture,
                    "RealisticOrbitalTrade.MinTimeUntilDepartureBeforeGraceTimeLabel".Translate(),
                    minHoursUntilDepartureBeforeGraceTime
                ),
                -1f,
#if v1_6
                (TipSignal?)
            ...
            minHoursUntilDepartureBeforeGraceTime = listingStandard.Slider(
                minHoursUntilDepartureBeforeGraceTime,
                1,
                16
            );
            _minTicksUntilDepartureBeforeGraceTime = (int)(
                minHoursUntilDepartureBeforeGraceTime * 2500f
            );
            ...
            listingStandard.Label(
                string.Format(
                    CultureInfo.CurrentCulture,
                    "RealisticOrbitalTrade.DepartureGraceTimeLabel".Translate(),
                    departureGraceTime
                ),
                -1f,
#if v1_6
        ...
        public static int GenerateDeviatingMinimumTradeThreshold()
        {
            ...
            var deviation =
                baseline
                * Rand.RangeInclusive(-_minimumTradeDeviation, _minimumTradeDeviation)
                / 100;
