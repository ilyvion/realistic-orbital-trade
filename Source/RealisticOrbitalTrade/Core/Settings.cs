...
internal class Settings : ModSettings
{
    ...
    public static void DoSettingsWindowContents(Rect inRect)
    {
        ...
        listingStandard.Label(
            "RealisticOrbitalTrade.MinimumTradeVariationLabel".Translate(_minimumTradeDeviation),
            -1f,
            "RealisticOrbitalTrade.MinimumTradeVariationTooltip".Translate(_minimumTradeDeviation)
        );
    ...
    public static int GenerateDeviatingMinimumTradeThreshold()
    {
        ...
        var deviation =
            baseline * Rand.RangeInclusive(-_minimumTradeDeviation, _minimumTradeDeviation) / 100;
