...
{
    protected override string DefaultLabel => "RealisticOrbitalTrade.CancelTradeAgreementLabel".Translate();

    protected override string DefaultDesc => "RealisticOrbitalTrade.CancelTradeAgreementDesc".Translate();
}
